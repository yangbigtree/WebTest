document.getElementById('signForm').addEventListener('submit', function(event) {
	...
	const usernameError = document.getElementById('user_err').value;
	const passwordError = document.getElementById('password_err').value;
	const phoneError = document.getElementById('phone_err').value;
	const emailError = document.getElementById('email_err').value;
